        ...
        >
          <div className="flex flex-col items-start justify-center row-start-2 sm:row-start-1">
            <h1 className="text-3xl font-medium leading-normal lg:text-4xl xl:text-5xl text-black-600">
              Empower your business with <strong>Scripto</strong>.
            </h1>
            <p className="mt-4 mb-6 text-black-500">
              Harness the power of tailored web applications that elevate your
              operations to new heights. Explore the limitless possibilities
              with us and unlock the future of your digital presence.
            </p>
