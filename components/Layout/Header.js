      ...
      >
        <nav className="grid max-w-screen-xl grid-flow-col px-6 py-3 mx-auto sm:px-8 lg:px-16 sm:py-4">
          <div className="flex items-center">
            ...
            <div className="flex items-center justify-center w-auto h-8">LOGO</div>

          </div>
          <ul className="flex items-center justify-end hidden col-start-4 col-end-8 lg:flex text-black-500">
            <LinkScroll
              activeClass="active"
              to="about"
              spy={true}
